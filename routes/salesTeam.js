 ...
 * @access  Sales Team, Admin, Super Admin
 */
router.get('/dashboard-stats', verifyToken, isSalesAuthorized, salesTeamController.getDashboardStats);
 ...
 * @access  Sales Team, Admin, Super Admin
 */
router.get('/users', verifyToken, isSalesAuthorized, salesTeamController.getAllUsersWithReferrals);
 ...
 * @access  Sales Team, Admin, Super Admin
 */
router.get('/users/:userId', verifyToken, isSalesAuthorized, salesTeamController.getUserDetail);
 ...
 * @access  Sales Team, Admin, Super Admin
 */
router.get('/users/:userId/orders', verifyToken, isSalesAuthorized, salesTeamController.getUserOrders);
 ...
 * @access  Sales Team, Admin, Super Admin
 */
router.get('/users/:userId/wishlist', verifyToken, isSalesAuthorized, salesTeamController.getUserWishlist);
 ...
 * @access  Sales Team, Admin, Super Admin
 */
router.get('/users/:userId/cart', verifyToken, isSalesAuthorized, salesTeamController.getUserCart);
