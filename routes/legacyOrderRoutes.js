/**
 * ==========================================
 * ⚠️  LEGACY ORDER SYSTEM - DEPRECATED ⚠️
 * ==========================================
 *
 * Date Deprecated: November 27, 2025
 * Reason: Unified order system implemented with enhanced features
 *
 * This file contains the OLD order system routes.
 * Keeping for backward compatibility with 6 existing orders.
 *
 * DO NOT USE FOR NEW ORDERS!
 * Use /api/orders instead (unified system)
 *
 * Migration Plan:
 * - Phase 1: Keep running for existing 6 orders ✅
 * - Phase 2: Complete all existing orders
 * - Phase 3: Remove this file after all orders completed
 *
 * New System Location: routes/orderRoutes.js
 * ==========================================
 */
